...
const appSettings = {
    databaseURL: "https://endorsement-94010-default-rtdb.europe-west1.firebasedatabase.app/"
}
...
//             appendItemsToendorsementListEl(currentItem)
//         }
...
// function appendItemsToendorsementListEl(item) {
//     // endorsementListEl.innerHTML += `<li> ${item} </li>`
//     let itemID = item[0]
...
//         let exactLocationOfitemsinDb = ref(database, `endorsement/${itemID}`)
